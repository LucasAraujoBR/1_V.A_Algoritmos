class Node:
    ...
    def imprimeArvore(self, indent = 15):
        print(" " * indent + str(self.data))
        if self.esquerda:
            self.esquerda.imprimeArvore(indent - 8)
        if self.direita:
            self.direita.imprimeArvore(indent + 15)


#Chaves: 13, 89, 81, 28, 21, 7, 83, 57, 2, 97, 24.
lista = [89, 81, 28, 21, 7, 83, 57, 2, 97, 24]
a = Node(13)
for i in lista:
    a.insere(i)
